...
| Consolidator v4 | Weekly (Sun 3am) | `tools/consolidator.py sessions` | Extracts facts from session transcripts |
...
0 3 * * 0 cd /path/to/rasputin-memory && python3 tools/consolidator.py sessions >> logs/consolidator.log 2>&1
