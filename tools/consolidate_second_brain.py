...
TARGET_COLLECTION = "second_brain"

# Collections to delete (empty)
EMPTY_COLLECTIONS = [
    "research", "default", "general", "jarvis_225_procedural_skills",
    "legacy_documents", "openclaw_memories", "jarvis_conversations", 
        ...
        try:
            for points in self.scroll_collection(coll_name, limit=100):
                for point in points:
                    ...
                    batch_points.append({
                        "id": point_id,
                        "payload": {**payload, "source_collection": coll_name}
                    })
        ...
        try:
            resp = requests.post(
                ...
                json={
                    "limit": 1,
                    "filter": {
                        "must": [{"key": "source_collection", "match": {"value": coll_name}}]
                    }
                }
            )
        ...
        try:
            ...
            resp = requests.post(
                ...
                json={
                    ...
                    "limit": 5,
                    "filter": {
                        "must": [{"key": "source_collection", "match": {"value": "gmail_import"}}]
                    }
                }
            )
